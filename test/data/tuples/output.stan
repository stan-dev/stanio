generated quantities {
  ...
  // array[3] tuple(array[2] tuple(real, vector[2]), complex) v = {({(1.2,
  //                                                                  [3.4, 4.5]'),
  //                                                                 (2.2,
  //                                                                  [4.4, 5.5]')},
  //                                                                3.56 + 7i),
  ...
  //                                                                   19.5]')},
  //                                                                20.56 + 22i)};
  // array[3] tuple(real, array[2] real) w = {(1, {2, 3}), (4, {5, 6}),
  //                                          (7, {8, 9})};
  // array[2] tuple(complex, matrix[3, 4]) x = {(1 + 3i, rep_matrix(0, 3, 4)),
  //                                            (2 + 4i, rep_matrix(2, 3, 4))};
}
